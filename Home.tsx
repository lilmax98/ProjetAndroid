...
const splTokenName = process.env.REACT_APP_SPL_TOKEN_TO_MINT_NAME ? process.env.REACT_APP_SPL_TOKEN_TO_MINT_NAME.toString() : "$BLD";
...
const Home = (props: HomeProps) => {
    ...
    const [price, setPrice] = useState(666);
        ...
        <main>
            <MainContainer>
                ...
                <MintContainer>
                    <DesContainer>
                        <NFT elevation={3}>
                            <h2>Undead Penguins : BLD Mint</h2>
                            <br/>
                            <div><Price
                                label={isActive && whitelistEnabled && (whitelistTokenBalance > 0) ? (whitelistPrice + " " + priceLabel) : (price + " " + priceLabel)}/><Image
                                src="undead_penguins_gif.gif"
                                alt="Undead Penguins available"/></div>
                            <br/>
                            ...
                            {wallet && isActive && solanaExplorerLink &&
                              <SolExplorerLink href={solanaExplorerLink} target="_blank">View on
                                ...
                                <h3>Powered by Undead Sols and Pixel Penguins</h3>
                        </NFT>
                    </DesContainer>
                </MintContainer>
            </MainContainer>
